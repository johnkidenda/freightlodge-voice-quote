...
describe("phone visual nits — logo B + powered-by", () => {
  ...
  it("powered-by stays inside the ~390 viewport and SW cache is current", () => {
    ...
    expect(sw).toMatch(/freightlodge-quote-v11/);
    expect(sw).not.toMatch(/freightlodge-quote-v10/);
  });
});
